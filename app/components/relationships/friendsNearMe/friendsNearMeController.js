                        ...
                        .success(function (response) {
                            for (i = 0; i < response.length; i++) { // for each request
                                ...
                                if (response[i].profilePhoto === null) {
                                    ...
                                    friend.profilePic = "https://s3-ap-southeast-2.amazonaws.com/images.pioneerroad.com.au/user-photos/" + response[i].friendId + "/profile-photo/" + response[i].profilePhoto.medium;
                                }
